...
class CounterLogic(LogicBase):
    ...
    _counting_mode = StatusVar('counting_mode', 'CONTINUOUS')
    ...
    def on_activate(self):
        ...
        self._counting_mode = CountingMode[self._counting_mode]
    ...
    def on_deactivate(self):
        ...
        self._counting_mode = self._counting_mode.name
