...
class MWSourceSMR20(Base,MWInterface):
    ...
    def __init__(self, manager, name, config = {}, **kwargs):
        ...
        if 'gpib_address' in config.keys():
            ...
            self.logMsg('MWSourceSMR20: did not find >>gpib_address<< '
        ...
        if 'gpib_timeout' in config.keys():
            ...
            self.logMsg('MWSourceSMR20: did not find >>gpib_timeout<< '
        ...
        try: 
            ...
            self.logMsg('MWSourceSMR20: initialised and connected to hardware.', 
                        msgType='status')
        except:
            self.logMsg('MWSourceSMR20: could not connect to the GPIB address '
                        '>>{0}<<.'.format(self._gpib_address), 
                        msgType='error')
    ...
    def set_frequency(self,freq):
        ...
        self._gpib_connetion.write(':FREQ {:e}'.format(freq))
    ...
    def turn_AM_on(self,depth):
        ...
        self._gpib_connetion.write('AM:SOUR EXT')
        self._gpib_connetion.write('AM:EXT:COUP DC')
        self._gpib_connetion.write('AM {:f}'.format(float(depth)))
        self._gpib_connetion.write('AM:STAT ON')
        self._gpib_connetion.write('*WAI')
    ...
    def turn_AM_off(self):
        ...
        self._gpib_connetion.write(':AM:STAT OFF')
        self._gpib_connetion.write('*WAI')
