...
class MotorDummy(Base, MotorInterface):
    ...
    def get_constraints(self):
        ...
        axis0 = {'label': self._x_axis.label, 'unit': 'm', 'ramp': ['Sinus', 'Linear'], 'pos_min': 0, 'pos_max': 100,
                 'pos_step': 0.001, 'vel_min': 0, 'vel_max': 100, 'vel_step': 0.01, 'acc_min': 0.1, 'acc_max': 0.0,
                 'acc_step': 0.0}

        axis1 = {'label': self._y_axis.label, 'unit': 'm', 'ramp': ['Sinus', 'Linear'], 'pos_min': 0, 'pos_max': 100,
                 'pos_step': 0.001, 'vel_min': 0, 'vel_max': 100, 'vel_step': 0.01, 'acc_min': 0.1, 'acc_max': 0.0,
                 'acc_step': 0.0}

        axis2 = {'label': self._z_axis.label, 'unit': 'm', 'ramp': ['Sinus', 'Linear'], 'pos_min': 0, 'pos_max': 100,
                 'pos_step': 0.001, 'vel_min': 0, 'vel_max': 100, 'vel_step': 0.01, 'acc_min': 0.1, 'acc_max': 0.0,
                 'acc_step': 0.0}
