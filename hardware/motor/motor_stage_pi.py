...
class MotorStagePI(Base, MotorInterface):
    ...
    _com_port_pi_xyz = ConfigOption('com_port_pi_xyz', 'ASRL1::INSTR', warn=True)
    _pi_xyz_baud_rate = ConfigOption('pi_xyz_baud_rate', 9600, warn=True)
    _pi_xyz_timeout = ConfigOption('pi_xyz_timeout', 1000, warn=True)
    _pi_xyz_term_char = ConfigOption('pi_xyz_term_char', '\n', warn=True)
    _first_axis_label = ConfigOption('pi_first_axis_label', 'x', warn=True)
    _second_axis_label = ConfigOption('pi_second_axis_label', 'y', warn=True)
    _third_axis_label = ConfigOption('pi_third_axis_label', 'z', warn=True)
    _first_axis_ID = ConfigOption('pi_first_axis_ID', '1', warn=True)
    _second_axis_ID = ConfigOption('pi_second_axis_ID', '2', warn=True)
    _third_axis_ID = ConfigOption('pi_third_axis_ID', '3', warn=True)

    _min_first = ConfigOption('pi_first_min', -0.1, warn=True)
    _max_first = ConfigOption('pi_first_max', 0.1, warn=True)
    _min_second = ConfigOption('pi_second_min', -0.1, warn=True)
    _max_second = ConfigOption('pi_second_max', 0.1, warn=True)
    _min_third = ConfigOption('pi_third_min', -0.1, warn=True)
    _max_third = ConfigOption('pi_third_max', 0.1, warn=True)

    step_first_axis = ConfigOption('pi_first_axis_step', 1e-7, warn=True)
    ...
    _vel_step_first = ConfigOption('vel_first_axis_step', 1e-5, warn=True)
    _vel_step_second = ConfigOption('vel_second_axis_step', 1e-5, warn=True)
    _vel_step_third = ConfigOption('vel_third_axis_step', 1e-5, warn=True)
