...
class NationalInstrumentsXSeriesDummy(Base, SlowCounterInterface, ConfocalScannerInterface, ODMRCounterInterface):
    ...
    def set_up_clock(self, clock_frequency=None, clock_channel=None, scanner=False, idle=False):
        ...
        # photon counting
        my_clock_daq_task = True#daq.TaskHandle()
        ...
        my_idle = True#daq.DAQmx_Val_High if idle else daq.DAQmx_Val_Low
        try:
    ...
    def get_counter(self, samples=None):
        ...
        self.dummy_data=np.random.rand(samples)*10*self._clock_frequency
    ...
    def _start_analog_output(self):
        ...
        #        daq.DAQmxClearTask(self._scanner_ao_task)
            ...
            self._scanner_ao_task = True#daq.TaskHandle()
    ...
    def _write_scanner_ao(self, voltages, length=1, start=False):
        ...
        self._AONwritten = True#daq.int32()
    ...
    def scan_line(self, line_path=None, pixel_clock=False):
        ...
        try:
            ...
            # stop the analog output task
            self._stop_analog_output()
            time.sleep(self._line_length/self._clock_frequency)
            #if pixel_clock and self._pixel_clock_channel is not None:
        ...
        self.dummy_data = np.random.rand(self._line_length) * 10 * self._clock_frequency
        return self.dummy_data.reshape(self._line_length,1)
    ...
    def count_odmr(self, length=100):
        ...
        """
        return False, np.full((len(self.get_odmr_channels()), 100), [-1.])
