...
class MagnetGui(GUIBase):
    ...
    sigChangeB = QtCore.Signal(list) # list: [B,theta,phi]
    ...
    def on_activate(self):
        ...
        self._mw.rotate_rel_B_m_PushButton.clicked.connect(self.rotate_rel_B_m_PushButton_clicked)
        self._mw.rotate_rel_B_p_PushButton.clicked.connect(self.rotate_rel_B_p_PushButton_clicked)
        self._mw.rotate_rel_theta_m_PushButton.clicked.connect(self.rotate_rel_theta_m_PushButton_clicked)
        self._mw.rotate_rel_theta_p_PushButton.clicked.connect(self.rotate_rel_theta_p_PushButton_clicked)
    ...
    def set_default_view_main_window(self):
        ...
        self._mw.change_rel_DockWidget.setFloating(False)
        ...
        self._mw.addDockWidget(QtCore.Qt.DockWidgetArea(1),
                               self._mw.change_rel_DockWidget)
        self._mw.addDockWidget(QtCore.Qt.DockWidgetArea(1),
    ...
    def on_activate_ulm(self):
        ...
        axis_list = list(self._magnetlogic.get_hardware_constraints())
       ...
       # self._mw.addDockWidget(QtCore.Qt.DockWidgetArea(3), self._mw.move_abs_DockWidget)
        self.set_default_view_main_window()
        raw_data_2d = self._magnetlogic.get_2d_data_matrix()
        ...
        self._magnetlogic.sigPosChanged.connect(self.update_pos)

        # Connect alignment GUI elements:

        self._magnetlogic.sigMeasurementFinished.connect(self._change_display_to_stop_2d_alignment)
        ...
        self._2d_alignment_ImageItem.setLookupTable(my_colors.lut)
        # Set initial position for the crosshair, default is current magnet position
        current_position = self._magnetlogic.get_pos()
        current_2d_array = self._magnetlogic.get_2d_axis_arrays()
        ini_pos_x_crosshair = current_position[self._magnetlogic.align_2d_axis0_name]
        ini_pos_y_crosshair = current_position[self._magnetlogic.align_2d_axis1_name]
        ...
        self._magnetlogic.sig2DAxisChanged.connect(self._update_2d_graph_axis)
        self._magnetlogic.sig2DMatrixChanged.connect(self._update_2d_graph_data)
        ...
        for axis_label in list(constraints):
            self.get_ref_move_rel_ScienDSpinBox(axis_label).setValue(self._magnetlogic.move_rel_dict[axis_label])
        ...
        index = self._mw.align_2d_axis0_name_ComboBox.findText(self._magnetlogic.align_2d_axis0_name)
        ...
        self._mw.align_2d_axis0_range_DSpinBox.setValue(self._magnetlogic.align_2d_axis0_range)
        ...
        self._mw.align_2d_axis0_step_DSpinBox.setValue(self._magnetlogic.align_2d_axis0_step)
        self._mw.align_2d_axis0_step_DSpinBox.editingFinished.connect(self.align_2d_axis0_step_changed)
        self._mw.align_2d_axis0_vel_DSpinBox.setValue(self._magnetlogic.align_2d_axis0_vel)
        self._mw.align_2d_axis0_vel_DSpinBox.editingFinished.connect(self.align_2d_axis0_vel_changed)

        index = self._mw.align_2d_axis1_name_ComboBox.findText(self._magnetlogic.align_2d_axis1_name)
        ...
        self._mw.align_2d_axis1_range_DSpinBox.setValue(self._magnetlogic.align_2d_axis1_range)
        ...
        self._mw.align_2d_axis1_step_DSpinBox.setValue(self._magnetlogic.align_2d_axis1_step)
        self._mw.align_2d_axis1_step_DSpinBox.editingFinished.connect(self.align_2d_axis1_step_changed)
        self._mw.align_2d_axis1_vel_DSpinBox.setValue(self._magnetlogic.align_2d_axis1_vel)
        self._mw.align_2d_axis1_vel_DSpinBox.editingFinished.connect(self.align_2d_axis1_vel_changed)

        # for fluorescence alignment:
        self._mw.align_2d_fluorescence_optimize_freq_SpinBox.setValue(self._magnetlogic.get_optimize_pos_freq())
        self._mw.align_2d_fluorescence_integrationtime_DSpinBox.setValue(self._magnetlogic.get_fluorescence_integration_time())
        ...
        self._mw.align_2d_odmr_low_fit_func_ComboBox.addItems(self._magnetlogic.odmr_2d_low_fitfunction_list)
        self._mw.align_2d_odmr_low_fit_func_ComboBox.setCurrentIndex(1)
        self._mw.align_2d_odmr_low_center_freq_DSpinBox.setValue(self._magnetlogic.odmr_2d_low_center_freq)
        self._mw.align_2d_odmr_low_range_freq_DSpinBox.setValue(self._magnetlogic.odmr_2d_low_range_freq)
        self._mw.align_2d_odmr_low_step_freq_DSpinBox.setValue(self._magnetlogic.odmr_2d_low_step_freq)
        self._mw.align_2d_odmr_low_power_DSpinBox.setValue(self._magnetlogic.odmr_2d_low_power)
        self._mw.align_2d_odmr_low_runtime_DSpinBox.setValue(self._magnetlogic.odmr_2d_low_runtime)

        self._mw.align_2d_odmr_high_fit_func_ComboBox.clear()
        self._mw.align_2d_odmr_high_fit_func_ComboBox.addItems(self._magnetlogic.odmr_2d_high_fitfunction_list)
        self._mw.align_2d_odmr_high_fit_func_ComboBox.setCurrentIndex(1)
        self._mw.align_2d_odmr_high_center_freq_DSpinBox.setValue(self._magnetlogic.odmr_2d_high_center_freq)
        self._mw.align_2d_odmr_high_range_freq_DSpinBox.setValue(self._magnetlogic.odmr_2d_high_range_freq)
        self._mw.align_2d_odmr_high_step_freq_DSpinBox.setValue(self._magnetlogic.odmr_2d_high_step_freq)
        self._mw.align_2d_odmr_high_power_DSpinBox.setValue(self._magnetlogic.odmr_2d_high_power)
        self._mw.align_2d_odmr_high_runtime_DSpinBox.setValue(self._magnetlogic.odmr_2d_high_runtime)

        self._mw.align_2d_odmr_save_after_measure_CheckBox.setChecked(self._magnetlogic.odmr_2d_save_after_measure)

        self._mw.odmr_2d_single_trans_CheckBox.stateChanged.connect(self._odmr_single_trans_alignment_changed)

        # peak shift for odmr:
        self._mw.align_2d_axis0_shift_DSpinBox.setValue(self._magnetlogic.odmr_2d_peak_axis0_move_ratio/1e12)
        self._mw.align_2d_axis1_shift_DSpinBox.setValue(self._magnetlogic.odmr_2d_peak_axis1_move_ratio/1e12)

        # for single shot alignment of a nuclear spin:
        self._mw.align_2d_nuclear_rabi_periode_DSpinBox.setValue(self._magnetlogic.nuclear_2d_rabi_periode)
        self._mw.align_2d_nuclear_mw_freq_DSpinBox.setValue(self._magnetlogic.nuclear_2d_mw_freq)
        self._mw.align_2d_nuclear_mw_channel_SpinBox.setValue(self._magnetlogic.nuclear_2d_mw_channel)
        self._mw.align_2d_nuclear_mw_power_DSpinBox.setValue(self._magnetlogic.nuclear_2d_mw_power)
        self._mw.align_2d_nuclear_laser_time_DSpinBox.setValue(self._magnetlogic.nuclear_2d_laser_time)
        self._mw.align_2d_nuclear_laser_channel_SpinBox.setValue(self._magnetlogic.nuclear_2d_laser_channel)
        self._mw.align_2d_nuclear_detect_channel_SpinBox.setValue(self._magnetlogic.nuclear_2d_detect_channel)
        self._mw.align_2d_nuclear_idle_time_DSpinBox.setValue(self._magnetlogic.nuclear_2d_idle_time)
        self._mw.align_2d_nuclear_reps_within_ssr_SpinBox.setValue(self._magnetlogic.nuclear_2d_reps_within_ssr)
        self._mw.align_2d_nuclear_num_of_ssr_SpinBox.setValue(self._magnetlogic.nuclear_2d_num_ssr)

        # process signals from magnet_logic

        self._magnetlogic.sigMoveRelChanged.connect(self.update_move_rel_para)

        self._magnetlogic.sig2DAxis0NameChanged.connect(self.update_align_2d_axis0_name)
        self._magnetlogic.sig2DAxis0RangeChanged.connect(self.update_align_2d_axis0_range)
        self._magnetlogic.sig2DAxis0StepChanged.connect(self.update_align_2d_axis0_step)
        self._magnetlogic.sig2DAxis0VelChanged.connect(self.update_align_2d_axis0_vel)

        self._magnetlogic.sig2DAxis1NameChanged.connect(self.update_align_2d_axis1_name)
        self._magnetlogic.sig2DAxis1RangeChanged.connect(self.update_align_2d_axis1_range)
        self._magnetlogic.sig2DAxis1StepChanged.connect(self.update_align_2d_axis1_step)
        self._magnetlogic.sig2DAxis1VelChanged.connect(self.update_align_2d_axis1_vel)

        self._magnetlogic.sigOptPosFreqChanged.connect(self.update_optimize_pos_freq)
        self._magnetlogic.sigFluoIntTimeChanged.connect(self.update_fluorescence_integration_time)
...
#            dspinbox_ref.setButtonSymbols(QtGui.QAbstractSpinBox.NoButtons)
    ...
    def move_rel(self, axis_label, direction):
        ...
        self._magnetlogic.move_rel({axis_label: movement})
    ...
    def move_abs(self, param_dict=None):
        ...
        if (param_dict is not None) and (type(param_dict) is not bool):
            self._magnetlogic.move_abs(param_dict)
        else:
            constraints = self._magnetlogic.get_hardware_constraints()
            ...
            self._magnetlogic.move_abs(move_abs)
    ...
    def move_rel_para_changed(self):
        ...
        """
        return_dict = dict()
        axes = list(self._magnetlogic.get_hardware_constraints())
        for axis_label in axes:
            dspinbox = self.get_ref_move_rel_ScienDSpinBox(axis_label)
            return_dict[axis_label]=dspinbox.value()
        self._magnetlogic.set_move_rel_para(return_dict)
        return return_dict
    ...
    def align_2d_axis0_name_changed(self):
        ...
        self._magnetlogic.set_align_2d_axis0_name(axisname)
        return axisname
    ...
    def align_2d_axis0_range_changed(self):
        ...
        self._magnetlogic.set_align_2d_axis0_range(axis_range)
        return axis_range
    ...
    def align_2d_axis0_step_changed(self):
        ...
        self._magnetlogic.set_align_2d_axis0_step(step)
        return step
    ...
    def align_2d_axis0_vel_changed(self):
        ...
        self._magnetlogic.set_align_2d_axis0_vel(vel)
        return vel
    ...
    def align_2d_axis1_name_changed(self):
        ...
        self._magnetlogic.set_align_2d_axis1_name(axisname)
        return axisname
    ...
    def align_2d_axis1_range_changed(self):
        ...
        self._magnetlogic.set_align_2d_axis1_range(axis_range)
        return axis_range
    ...
    def align_2d_axis1_step_changed(self):
        ...
        self._magnetlogic.set_align_2d_axis1_step(step)
        return step
    ...
    def align_2d_axis1_vel_changed(self):
        ...
        self._magnetlogic.set_align_2d_axis1_vel(vel)
        return vel
    ...
    def optimize_pos_freq_changed(self):
        ...
        self._magnetlogic.set_optimize_pos_freq(freq)
        return freq
    ...
    def fluorescence_integration_time_changed(self):
        ...
        self._magnetlogic.set_fluorescence_integration_time(time)
        return time
    ...
    def stop_movement(self):
        ...
        if self._interactive_mode:
            self._magnetlogic.stop_movement()
        else:
    ...
    def update_pos(self, param_list=None):
        ...
        self._mw.alignment_2d_GraphicsView.set_crosshair_pos(
            [curr_pos[self._magnetlogic.align_2d_axis0_name],
             curr_pos[self._magnetlogic.align_2d_axis1_name]])
        return curr_pos
    ...
    def start_2d_alignment_clicked_ulm(self):
        ...
        if self.measurement_type == '2d_fluorescence':
            self._magnetlogic.curr_alignment_method = self.measurement_type

            self._magnetlogic.fluorescence_integration_time = self._mw.align_2d_fluorescence_integrationtime_DSpinBox.value()
            self._mw.alignment_2d_cb_GraphicsView.setLabel('right', 'Fluorescence', units='c/s')

        elif self.measurement_type == '2d_odmr':
            self._magnetlogic.curr_alignment_method = self.measurement_type

            self._magnetlogic.odmr_2d_low_center_freq = self._mw.align_2d_odmr_low_center_freq_DSpinBox.value()
            self._magnetlogic.odmr_2d_low_range_freq = self._mw.align_2d_odmr_low_range_freq_DSpinBox.value()
            self._magnetlogic.odmr_2d_low_step_freq = self._mw.align_2d_odmr_low_step_freq_DSpinBox.value()
            self._magnetlogic.odmr_2d_low_power = self._mw.align_2d_odmr_low_power_DSpinBox.value()
            self._magnetlogic.odmr_2d_low_runtime  = self._mw.align_2d_odmr_low_runtime_DSpinBox.value()
            self._magnetlogic.odmr_2d_low_fitfunction = self._mw.align_2d_odmr_low_fit_func_ComboBox.currentText()

            self._magnetlogic.odmr_2d_high_center_freq = self._mw.align_2d_odmr_high_center_freq_DSpinBox.value()
            self._magnetlogic.odmr_2d_high_range_freq = self._mw.align_2d_odmr_high_range_freq_DSpinBox.value()
            self._magnetlogic.odmr_2d_high_step_freq = self._mw.align_2d_odmr_high_step_freq_DSpinBox.value()
            self._magnetlogic.odmr_2d_high_power = self._mw.align_2d_odmr_high_power_DSpinBox.value()
            self._magnetlogic.odmr_2d_high_runtime = self._mw.align_2d_odmr_high_runtime_DSpinBox.value()
            self._magnetlogic.odmr_2d_high_fitfunction = self._mw.align_2d_odmr_high_fit_func_ComboBox.currentText()

            self._magnetlogic.odmr_2d_peak_axis0_move_ratio = self._mw.align_2d_axis0_shift_DSpinBox.value()*1e12
            self._magnetlogic.odmr_2d_peak_axis1_move_ratio = self._mw.align_2d_axis1_shift_DSpinBox.value()*1e12

            self._magnetlogic.odmr_2d_single_trans = self._mw.odmr_2d_single_trans_CheckBox.isChecked()
            ...
            # ODMR stuff:
            self._magnetlogic.odmr_2d_low_center_freq = self._mw.align_2d_odmr_low_center_freq_DSpinBox.value()*1e6
            self._magnetlogic.odmr_2d_low_step_freq = self._mw.align_2d_odmr_low_step_freq_DSpinBox.value()*1e6
            self._magnetlogic.odmr_2d_low_range_freq = self._mw.align_2d_odmr_low_range_freq_DSpinBox.value()*1e6
            self._magnetlogic.odmr_2d_low_power = self._mw.align_2d_odmr_low_power_DSpinBox.value()
            self._magnetlogic.odmr_2d_low_runtime  = self._mw.align_2d_odmr_low_runtime_DSpinBox.value()
            self._magnetlogic.odmr_2d_low_fitfunction = self._mw.align_2d_odmr_low_fit_func_ComboBox.currentText()
            ...
            # nuclear ops:
            self._magnetlogic.nuclear_2d_rabi_periode = self._mw.align_2d_nuclear_rabi_periode_DSpinBox.value()*1e-9
            self._magnetlogic.nuclear_2d_mw_freq = self._mw.align_2d_nuclear_mw_freq_DSpinBox.value()*1e6
            self._magnetlogic.nuclear_2d_mw_channel = self._mw.align_2d_nuclear_mw_channel_SpinBox.value()
            self._magnetlogic.nuclear_2d_mw_power = self._mw.align_2d_nuclear_mw_power_DSpinBox.value()
            self._magnetlogic.nuclear_2d_laser_time = self._mw.align_2d_nuclear_laser_time_DSpinBox.value()
            self._magnetlogic.nuclear_2d_laser_channel = self._mw.align_2d_nuclear_laser_channel_SpinBox.value()
            self._magnetlogic.nuclear_2d_detect_channel = self._mw.align_2d_nuclear_detect_channel_SpinBox.value()
            self._magnetlogic.nuclear_2d_idle_time = self._mw.align_2d_nuclear_idle_time_DSpinBox.value()
            self._magnetlogic.nuclear_2d_reps_within_ssr = self._mw.align_2d_nuclear_reps_within_ssr_SpinBox.value()
            self._magnetlogic.nuclear_2d_num_ssr = self._mw.align_2d_nuclear_num_of_ssr_SpinBox.value()
        ...
        self._magnetlogic.start_2d_alignment(continue_meas=self._continue_2d_fluorescence_alignment)
    ...
    def abort_2d_alignment_clicked_ulm(self):
        ...
        self._magnetlogic.stop_alignment()
    ...
    def _update_2d_graph_axis_ulm(self):
        ...
        axis0_array, axis1_array = self._magnetlogic.get_2d_axis_arrays()
