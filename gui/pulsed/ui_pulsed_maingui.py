...
# Form implementation generated from reading ui file 'ui_pulsed_maingui.ui'
#
# Created: Mon Jun 29 18:29:55 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.del_repeat_row_PushButton = QtGui.QPushButton(self.tab_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.del_repeat_row_PushButton.sizePolicy().hasHeightForWidth())
        self.del_repeat_row_PushButton.setSizePolicy(sizePolicy)
        self.del_repeat_row_PushButton.setMaximumSize(QtCore.QSize(40, 16777215))
        self.del_repeat_row_PushButton.setObjectName(_fromUtf8("del_repeat_row_PushButton"))
        self.gridLayout_17.addWidget(self.del_repeat_row_PushButton, 2, 1, 1, 1)
        self.add_repeat_row_PushButton = QtGui.QPushButton(self.tab_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.add_repeat_row_PushButton.sizePolicy().hasHeightForWidth())
        self.add_repeat_row_PushButton.setSizePolicy(sizePolicy)
        self.add_repeat_row_PushButton.setMaximumSize(QtCore.QSize(40, 16777215))
        self.add_repeat_row_PushButton.setObjectName(_fromUtf8("add_repeat_row_PushButton"))
        self.gridLayout_17.addWidget(self.add_repeat_row_PushButton, 1, 1, 1, 1)
        ...
        self.add_init_row_PushButton = QtGui.QPushButton(self.tab_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.add_init_row_PushButton.sizePolicy().hasHeightForWidth())
        self.add_init_row_PushButton.setSizePolicy(sizePolicy)
        self.add_init_row_PushButton.setMinimumSize(QtCore.QSize(0, 0))
        self.add_init_row_PushButton.setMaximumSize(QtCore.QSize(40, 16777215))
        self.add_init_row_PushButton.setBaseSize(QtCore.QSize(40, 0))
        self.add_init_row_PushButton.setToolTip(_fromUtf8(""))
        self.add_init_row_PushButton.setObjectName(_fromUtf8("add_init_row_PushButton"))
        self.gridLayout_11.addWidget(self.add_init_row_PushButton, 1, 1, 1, 1)
        ...
        self.del_init_row_PushButton = QtGui.QPushButton(self.tab_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.del_init_row_PushButton.sizePolicy().hasHeightForWidth())
        self.del_init_row_PushButton.setSizePolicy(sizePolicy)
        self.del_init_row_PushButton.setMaximumSize(QtCore.QSize(40, 16777215))
        self.del_init_row_PushButton.setObjectName(_fromUtf8("del_init_row_PushButton"))
        self.gridLayout_11.addWidget(self.del_init_row_PushButton, 3, 1, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1167, 662))
...
"Phase (°)", None))
        ...
        self.del_repeat_row_PushButton.setText(_translate("MainWindow", "Del.", None))
        self.add_repeat_row_PushButton.setText(_translate("MainWindow", "Add", None))
        self.clear_init_table_PushButton.setText(_translate("MainWindow", "Clear", None))
        self.add_init_row_PushButton.setText(_translate("MainWindow", "Add", None))
...
"Phase (°)", None))
        ...
        item.setText(_translate("MainWindow", "Use as tau?", None))
        self.del_init_row_PushButton.setText(_translate("MainWindow", "Del.", None))
