...
class ConfocalGui(GUIBase):
    ...
    default_position_prefix = ConfigOption(name='default_position_prefix', default=None)
    ...
    def init_main(self):
        ...
        self._generate_widgets_from_axes()
        ...
        self._mw.sigDoubleClicked.connect(self.activate_zoom_double_click)
