...
#
# Created: Wed Jul  1 11:43:22 2015
...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.gridLayout.addWidget(self.savePNG_checkBox, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.save_purePNG_checkBox, 8, 2, 1, 1)
        ...
        self.slider_small_step_SpinBox = QtGui.QSpinBox(SettingsDialog)
        self.slider_small_step_SpinBox.setMaximum(10000)
        self.slider_small_step_SpinBox.setSingleStep(10)
        self.slider_small_step_SpinBox.setProperty("value", 10)
        self.slider_small_step_SpinBox.setObjectName(_fromUtf8("slider_small_step_SpinBox"))
        self.gridLayout.addWidget(self.slider_small_step_SpinBox, 5, 2, 1, 1)
        ...
        self.slider_big_step_SpinBox = QtGui.QSpinBox(SettingsDialog)
        self.slider_big_step_SpinBox.setMaximum(10000)
        self.slider_big_step_SpinBox.setSingleStep(10)
        self.slider_big_step_SpinBox.setProperty("value", 100)
        self.slider_big_step_SpinBox.setObjectName(_fromUtf8("slider_big_step_SpinBox"))
        self.gridLayout.addWidget(self.slider_big_step_SpinBox, 6, 2, 1, 1)
        ...
        SettingsDialog.setTabOrder(self.fixed_aspect_depth_checkBox, self.savePNG_checkBox)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.slider_small_step_SpinBox.setToolTip(_translate("SettingsDialog", "<html><head/><body><p><span style=\" font-size:10pt;\">Change the stepsize of a slider if you are using the keyboard to move the slider position. Here you can adjust the small steps for the crosshair move.</span></p></body></html>", None))
        self.label_6.setToolTip(_translate("SettingsDialog", "<html><head/><body><p>Change the stepsize of a slider if you are using the keyboard to move the slider position. Here you can adjust the big steps for the crosshair move.<br/>The keyboard configuration is the following:<br/>Ctrl + ArrowLeft = Move -x<br/>Ctrl + ArrowRight = Move +x<br/>Ctrl + ArrowUp = Move +y<br/>Ctrl + ArrowDown = Move -y<br/>Ctrl + PageUp = Move +z<br/>Ctrl + PageDown = Move -z</p></body></html>", None))
        self.label_6.setText(_translate("SettingsDialog", "Slider big step with Keys (nm):", None))
        self.slider_big_step_SpinBox.setToolTip(_translate("SettingsDialog", "<html><head/><body><p><span style=\" font-size:10pt;\">Change the stepsize of a slider if you are using the keyboard to move the slider position. Here you can adjust the big steps for the crosshair move.</span></p></body></html>", None))
