...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.guimod = QtGui.QWidget()
        self.guimod.setGeometry(QtCore.QRect(0, 0, 450, 328))
        self.guimod.setObjectName(_fromUtf8("guimod"))
        self.gridLayout1 = QtGui.QGridLayout(self.guimod)
        self.gridLayout1.setObjectName(_fromUtf8("gridLayout1"))
        self.scrollArea = QtGui.QScrollArea(self.guimod)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName(_fromUtf8("scrollArea"))
        self.guiscroll = QtGui.QWidget()
        self.guiscroll.setGeometry(QtCore.QRect(0, 0, 430, 308))
        ...
        self.toolBox.addItem(self.guimod, _fromUtf8(""))
        self.logicmod = QtGui.QWidget()
        self.logicmod.setGeometry(QtCore.QRect(0, 0, 98, 88))
        self.logicmod.setObjectName(_fromUtf8("logicmod"))
        self.gridLayout2 = QtGui.QGridLayout(self.logicmod)
        self.gridLayout2.setObjectName(_fromUtf8("gridLayout2"))
        self.scrollArea1 = QtGui.QScrollArea(self.logicmod)
        self.scrollArea1.setWidgetResizable(True)
        self.scrollArea1.setObjectName(_fromUtf8("scrollArea1"))
        self.logicscroll = QtGui.QWidget()
        self.logicscroll.setGeometry(QtCore.QRect(0, 0, 98, 28))
        ...
        self.toolBox.addItem(self.logicmod, _fromUtf8(""))
        self.hwmod = QtGui.QWidget()
        self.hwmod.setGeometry(QtCore.QRect(0, 0, 98, 88))
        self.hwmod.setObjectName(_fromUtf8("hwmod"))
        self.gridLayout3 = QtGui.QGridLayout(self.hwmod)
        self.gridLayout3.setObjectName(_fromUtf8("gridLayout3"))
        self.scrollArea2 = QtGui.QScrollArea(self.hwmod)
        self.scrollArea2.setWidgetResizable(True)
        self.scrollArea2.setObjectName(_fromUtf8("scrollArea2"))
        self.hwscroll = QtGui.QWidget()
        self.hwscroll.setGeometry(QtCore.QRect(0, 0, 98, 28))
        ...
        self.toolBox.addItem(self.hwmod, _fromUtf8(""))
        self.config = QtGui.QWidget()
        self.config.setGeometry(QtCore.QRect(0, 0, 98, 88))
        self.config.setObjectName(_fromUtf8("config"))
        self.gridLayout4 = QtGui.QGridLayout(self.config)
        self.gridLayout4.setObjectName(_fromUtf8("gridLayout4"))
        self.treeWidget = QtGui.QTreeWidget(self.config)
        self.treeWidget.setObjectName(_fromUtf8("treeWidget"))
        self.treeWidget.headerItem().setText(0, _fromUtf8("1"))
        self.gridLayout4.addWidget(self.treeWidget, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.loadAllButton, 1, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.guimod), _translate("MainWindow", "GUI modules", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.logicmod), _translate("MainWindow", "Logic modules", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.hwmod), _translate("MainWindow", "Hardware modules", None))
        ...
        self.versionLabel.setText(_translate("MainWindow", "<html><head/><body><p>Software version</p></body></html>", None))
