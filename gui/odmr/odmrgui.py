...
class ODMRGui(GUIBase):
    ...
    def on_activate(self):
        ...
        *.ui file and configures the event handling between the modules.
        ...
        self._mw.step_freq_DoubleSpinBox.setSingleStep(0.0)  # set dynamic step size
        ...
        self._mw.cw_power_DoubleSpinBox.setSingleStep(0.0)  # set dynamic step size
        ...
        self._mw.sweep_power_DoubleSpinBox.setSingleStep(0.0)  # set dynamic step size
