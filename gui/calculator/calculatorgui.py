...
class CalculatorGui(GUIBase):
    ...
    _modtype = 'gui'
    ## declare connectors
    calculatorlogic = Connector(interface='CalculatorLogic')
    ...
    def on_activate(self):
        ...
        """
        self._mw = CalculatorMainWindow()
        self.calculator = self.calculatorlogic()
...
class CalculatorMainWindow(QtWidgets.QMainWindow):
    """ Create the Calculator GUI window.
    """
    def __init__(self):
        # Get the path to the *.ui file
        this_dir = os.path.dirname(__file__)
        ui_file = os.path.join(this_dir, 'ui_calculator.ui')
