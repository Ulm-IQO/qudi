...
class PIDGui(GUIBase):
    ...
    def updateData(self, value):
        ...
        if self._pid_logic.enable:
            ...
            self._mw.labelkP.setText('{0:,.6f}'.format(self._pid_logic.kP))
            self._mw.labelkI.setText('{0:,.6f}'.format(self._pid_logic.kI))
            self._mw.labelkD.setText('{0:,.6f}'.format(self._pid_logic.kD))
