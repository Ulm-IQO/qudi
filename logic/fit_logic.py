            ...
            if data_max>abs(data_min):
                try:
                    self.logMsg('The lorentzian estimator set the peak to the '
                                'minimal value, if you want to fit a peak '
                                'instead of a dip rewrite the estimator.',
                                msgType='warning')
                except:
                    print('The lorentzian estimator set the peak to the '
                          'minimal value, if you want to fit a peak instead of '
                          'a dip rewrite the estimator.')
