...
class StepperScannerInterfuse(Base, ConfocalScannerInterface, PiezoStepperInterface,
    ...
    def on_activate(self, e):
        ...
        self._counter = self.get_in_connector('confocalscanner1')
        self._scanning_device = self.get_in_connector('piezostepper1')
        self._analogreader = self.get_in_connector('analogreader1')
    ...
    def reset_hardware(self):
        ...
        """
        return self._counter.reset_hardware()
    ...
    def set_position_range(self, myrange=None):
        ...
        @return int: error code (0:OK, -1:error)
        """
        return self._scanning_device.get_position_range(myrange)
