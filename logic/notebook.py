...
from notebook.base.handlers import Template404
...
from notebook.base.handlers import FileFindHandler, IPythonHandler
...
from notebook.utils import url_path_join, check_pid
...
class NotebookLogic(GenericLogic):        
    """ Logic module 
    """
    _modclass = 'ZMQKernelLogic'
    _modtype = 'logic'
    _out = {'kernel': 'ZMQKernelLogic'}
    ...
    def deactivation(self, e):
        ...
        if NotebookApp.initialized():
            ...
            self.logMsg('Notebookserver down.')
...
class NotebookApp(JupyterApp):
    ...
    def _notebook_dir_default(self):
        return os.path.join(py3compat.getcwd(), 'notebooks')
